	 ...
	 public void send(String host,String user,String pwd) {
	  ...
	  this.pwd  = pwd;
	    ...
	    public static void main(String[] args){
	     ...
	     //设置发件人地址、收件人地址和邮件标题
	     cn.setAddress("zealjiang@126.com","zealjiang@126.com","一个带附件的JavaMail邮件(标题)");
	     //设置要发送附件的位置和标题
	     cn.setAffix("D:/jiuzhaigou2.1.4.txt","九寨附件");
	     //设置smtp服务器以及邮箱的帐号和密码
	     cn.send("smtp.126.com","zealjiang@126.com","邮箱密码");
	    }
}
